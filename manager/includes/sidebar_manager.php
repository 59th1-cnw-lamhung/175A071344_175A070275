  ...
  <li CLASS="nav-item">
   ...
   <li CLASS="nav-item">
    ...
    <div id="collapseThree" CLASS="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div CLASS="bg-white py-2 collapse-inner rounded">
        <h6 CLASS="collapse-header">Chức năng</h6>
        <a CLASS="collapse-item" href="subject_class.php" target="iframe">Tạo lớp môn học</a>
        <a CLASS="collapse-item" href="info_subjectclass.php" target="iframe">Thông tin lớp môn học</a>
